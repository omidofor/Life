...
`,xs={root:"p-iftalabel"},Ls=j.extend({name:"iftalabel",style:Ss,classes:xs}),Ps={name:"BaseIftaLabel",extends:ee,style:Ls,provide:function(){return{$pcIftaLabel:this,$parentInstance:this}}},oe={name:"IftaLabel",extends:Ps,inheritAttrs:!1};function $s(t,e,n,o,r,i){return d(),m("span",p({class:t.cx("root")},t.ptmi("root")),[C(t.$slots,"default")],16)}oe.render=$s;var Os=re`
    .p-toast {
...
`,Bf={root:"p-inputgroup"},Df=j.extend({name:"inputgroup",style:Af,classes:Bf}),Vf={name:"BaseInputGroup",extends:ee,style:Df,provide:function(){return{$pcInputGroup:this,$parentInstance:this}}},tr={name:"InputGroup",extends:Vf,inheritAttrs:!1};function Ff(t,e,n,o,r,i){return d(),m("div",p({class:t.cx("root")},t.ptmi("root")),[C(t.$slots,"default")],16)}tr.render=Ff;var jf={root:"p-inputgroupaddon"},Nf=j.extend({name:"inputgroupaddon",classes:jf}),Hf={name:"BaseInputGroupAddon",extends:ee,style:Nf,provide:function(){return{$pcInputGroupAddon:this,$parentInstance:this}}},nr={name:"InputGroupAddon",extends:Hf,inheritAttrs:!1};function Rf(t,e,n,o,r,i){return d(),m("div",p({class:t.cx("root")},t.ptmi("root")),[C(t.$slots,"default")],16)}nr.render=Rf;var Uf=re`
    .p-togglebutton {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
